...
class TestJavaHunter(TestCase):
    ...
    def test_java_ast_extractor_member_reference(self):
        ...
        test_member_reference = MemberReference(member="test_member")
    ...
    def test_java_ast_extractor_method_invocation(self):
        ...
        test_method_invocation_1 = MethodInvocation(
            member="spanBuilder",
            qualifier="tracer",
            arguments=[Literal(value="test_span")],
        )

        test_method_invocation_2 = MethodInvocation(
            member="setAttribute",
            qualifier="span",
            arguments=[Literal(value="test_key"), Literal(value="test_value")],
        )
                ...
                "arguments": [
                    "operation_started",
                    {
                        ...
                        "qualifier": {
                            ...
                            "arguments": ["description", "Load User from DB"],
                            "selectors": None,
                        },
                        "arguments": [],
                        "selectors": None,
    ...
    def test_java_ast_extractor_class_creator(self):
        ...
        test_creator_1 = ClassCreator(
            type=MemberReference(member="HashMap"), arguments=[], body=None
        )
        ...
        test_creator_2 = ClassCreator(
            ...
            body=[
                ...
                MethodInvocation(
                    member="put",
                    qualifier=None,
                    arguments=[Literal(value="result"), Literal(value="123")],
                ),
                MethodInvocation(member="build", qualifier=None, arguments=[]),
            ],
        )
        ...
        test_creator_3 = ClassCreator(
            ...
            body=[
                MethodInvocation(
                    member="spanBuilder",
                    qualifier=None,
                    arguments=[Literal(value="span_name")],
                )
            ],
        )
    ...
    def test_java_ast_extractor_reference_type(self):
        ...
        test_ref_1 = ReferenceType(
            name=["io", "opentelemetry", "api", "trace", "Tracer"]
        )
        test_ref_2 = ReferenceType(name=["io", "opentelemetry", "api", "trace", "Span"])
        test_ref_3 = ReferenceType(
            name=["io", "opentelemetry", "api", "trace", "SpanBuilder"]
        )
    ...
    def test_java_ast_extractor_for_statement(self):
        ...
        test_for_statement_2 = ForStatement(
            ...
            body=BlockStatement(
                statements=[
                    ReturnStatement(expression=MemberReference(member="requestId")),
                    MethodInvocation(
                        member="add",
                    ...
                    {"expression": "requestId"},
                    {
                        ...
                        "arguments": [
                            1,
                            {
                                "method": "of",
                                "qualifier": "Attributes",
                                "arguments": ["endpoint", "path", "method", "method"],
                                "selectors": None,
                            },
                        ],
                        "selectors": None,
    ...
    def test_java_ast_extractor_if_statement(self):
        ...
        expected = {
            "condition": {"operandl": "span", "operator": None, "operandr": "null"},
            "then_statement": [
                {
                    "name": None,
                    "dimensions": None,
                ...
                },
                {
                    "expression": {
                        "method": "setStatus",
                        "qualifier": "span",
                        "arguments": ["StatusCode.ERROR", "errorDescription"],
                        "selectors": None,
                    }
                },
                {
