...
class TestJavaScriptSniffer(TestCase):
    def setUp(self):
        ...
        self.script_1 = os.path.join(
            base_path, "tests", "samples", "java", "script_1.java"
        )
        self.script_2 = os.path.join(
            base_path, "tests", "samples", "java", "script_2.java"
        )
        self.script_3 = os.path.join(
            base_path, "tests", "samples", "java", "script_3.java"
        )
        self.script_4 = os.path.join(
            base_path, "tests", "samples", "java", "script_4.java"
        )
