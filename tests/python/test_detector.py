...
class TestPythonTelemetryDetector(TestCase):
    def setUp(self):
        ...
        test_script_1 = os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "samples",
            "python",
            "script_1.py",
        )
        test_script_2 = os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "samples",
            "python",
            "script_2.py",
        )
        test_script_3 = os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "samples",
            "python",
            "script_3.py",
        )
        test_script_4 = os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "samples",
            "python",
            "script_4.py",
    ...
    def test_telemetry_detector_basic(self):
        ...
        expected = {
            ...
            "spans": [TelemetryCall(func="random_function", line_number=14, args=None)],
            "attributes": [
                TelemetryCall(
                    func="set_attribute",
                    line_number=15,
    ...
    def test_telemetry_detector_complex(self):
        ...
        expected = {
            "tracers": [TelemetryCall(func="__name__", line_number=8, args=None)],
            "spans": [
                TelemetryCall(
                    func="random_function_2", line_number=57, args=None, keywords=None
                ),
                TelemetryCall(
                    func="last_function", line_number=86, args=None, keywords=None
                ),
                TelemetryCall(
                    func="random_function_1", line_number=34, args=None, keywords=None
                ),
                TelemetryCall(
                    func="random_function_3", line_number=78, args=None, keywords=None
                ),
                TelemetryCall(
                    func="load_user_from_db", line_number=80, args=None, keywords=None
                ),
                TelemetryCall(
            ...
            "attributes": [
                TelemetryCall(
                    ...
                    line_number=58,
                    args={
                        "func": "span.set_attributes",
                        "args": [{"input_1": "val1", "input_2": "val2"}],
                    },
                ),
                TelemetryCall(
                    func="set_attribute",
                    line_number=35,
                    args={"func": "span.set_attribute", "args": ["val1", "val1"]},
                ),
                TelemetryCall(
                    func="set_attribute",
                    line_number=36,
                    args={"func": "span.set_attribute", "args": ["val2", "val2"]},
                ),
                TelemetryCall(
                    func="set_attribute",
                    line_number=108,
            ...
            "events": [
                TelemetryCall(
                    ...
                    args={
                        ...
                        "args": [
                            "calculation_completed",
                            {"operation": "subtraction", "result": "result"},
                        ],
                    },
                ),
                TelemetryCall(
            ...
            "counter": [
                ...
                TelemetryCall(
                    ...
                    args={
                        "func": "request_counter.add",
                        "args": [1, {"endpoint": "/api/v1", "method": "GET"}],
                    },
                    keywords=None,
                ),
                TelemetryCall(
    ...
    def test_telemetry_detector_exception(self):
        ...
        expected = {
            ...
            "spans": [TelemetryCall(func="fetch_data", line_number=26, args=None)],
            "attributes": [
                TelemetryCall(
                    func="set_attribute",
                    line_number=27,
                ...
                TelemetryCall(
                    ...
                    args={
                        "func": "span.set_attribute",
                        "args": ["data_size", {"func": "len", "args": ["raw_data"]}],
                    },
                ),
            ],
            "events": [
                TelemetryCall(
                    ...
                    args={
                        ...
                        "args": [
                            "data_processed",
                            {
                                "input_size": {"func": "len", "args": ["raw_data"]},
                                "output_size": {
                                    "func": "len",
                                    "args": ["processed_data"],
                                },
