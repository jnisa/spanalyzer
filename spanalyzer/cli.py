...
def main():
    ...
    parser.add_argument('-l', '--language', type=str, help='Language of the scripts to be analyzed', choices=['python', 'java'], default='python')
    
    args = parser.parse_args()

    engine = Engine(args.path, args.report_type, language=args.language, output_path=args.output)
